...
#capture video
model=torch.hub.load('ultralytics/yolov5', 'custom', path='C:/Users\Kaushik Vishwakarma/OneDrive/Desktop/Projects/driver-drowsiness-detection-main/driver-drowsiness-detection-main/proj/best.pt',force_reload=True) # weights are stored and accessed using the path given 
